...
public class frag_entertainment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        @SuppressLint("InflateParams") View v= inflater.inflate(R.layout.fragment_entertainment,null);

        recyclerViewofentertainment=v.findViewById(R.id.recycle_entertainment);
